...
- [Kaggle BraTS2020](https://www.kaggle.com/datasets/awsaf49/brats20-dataset-training-validation): optional alternative volumetric source, linked in the data tab. Not downloaded: the Hugging Face sample already supplies complete 3D studies. Downloaded four-sequence cases can be imported using Upload MRI. Unordered 2D classification images are not converted into invented 3D volumes.
